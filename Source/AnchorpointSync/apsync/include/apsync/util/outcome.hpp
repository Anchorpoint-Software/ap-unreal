...
#if 0L || (defined(_HAS_CXX17) && _HAS_CXX17 && _MSC_VER >= 1911 /* VS2017.3 */)
...
#else
// fix for qt moc generation
#define OUTCOME_V2_NAMESPACE outcome_v2_35644f5c /*QUICKCPPLIB_BIND_NAMESPACE(OUTCOME_V2)*/
#define OUTCOME_V2_NAMESPACE_BEGIN namespace outcome_v2_35644f5c { /* QUICKCPPLIB_BIND_NAMESPACE_BEGIN(OUTCOME_V2)*/
#define OUTCOME_V2_NAMESPACE_EXPORT_BEGIN namespace outcome_v2_35644f5c { /*QUICKCPPLIB_BIND_NAMESPACE_BEGIN(OUTCOME_V2)*/
#define OUTCOME_V2_NAMESPACE_END }  /*QUICKCPPLIB_BIND_NAMESPACE_END(OUTCOME_V2)*/
#endif
...
#include <atomic>
#include <cassert>
#if defined(__cpp_impl_coroutine) && __cpp_impl_coroutine || (defined(_MSC_VER) && __cpp_coroutines) || (defined(__clang__) && __cpp_coroutines)
